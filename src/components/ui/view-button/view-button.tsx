...
export const ViewButton: FC<ViewButtonProps> = ({ handler, active=false, lineIcon=false, searchIcon=false}) => {
    const buttonHandler = () => {
        if (handler) handler();
    }
    ...
    const iconChoice = () => {
        ...
        if (searchIcon) {
            return (
                <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" className={styled.searchIcon}>
